...
--
-- Hôte : mariadb:3306
-- Généré le : mer. 19 avr. 2023 à 23:37
...
INSERT INTO `attaque` (`id`, `nom`, `puissance`, `précision`, `type_id`, `description`, `PP`, `Catégorie`) VALUES
(1, 'Charge', 35, 100, 9, 'Charge l\'ennemi avec un violent plaquage.', 56, 'Physique'),
(2, 'Rugissement', 0, 100, 9, 'Le lanceur pousse un cri tout mimi pour tromper la vigilance de l\'ennemi et baisser son Attaque', 61, 'Statut'),
(3, 'Griffe', 40, 100, 9, 'Lacère l\'ennemi avec des griffes acérées pour lui infliger des dégâts.', 56, 'Physique'),
(4, 'Fouet Lianes', 35, 100, 10, 'Fouette l\'ennemi avec de fines lianes pour infliger des dégâts.', 16, 'Physique'),
(5, 'Mimi-Queue', 0, 100, 9, 'Le lanceur remue son adorable queue pour tromper la vigilance de l\'ennemi et baisser sa Défense.', 48, 'Statut'),
(6, 'Pistolet à O', 40, 100, 4, 'De l\'eau est projetée sur l\'ennemi en arc de cercle.', 40, 'Spéciale'),
(7, 'Flammèche', 40, 100, 6, 'L\'ennemi est attaqué par de faibles flammes. Peut aussi le brûler.', 40, 'Spéciale');
